...
///////////////////////////////////////////////receipt/////////////////////////////////////
	...
	//---------------------------------------------------------Pick Car Buttton]
	//-------------------------------------first car button
		ImageIcon firstCarImage = new ImageIcon("../images/chainsaw.jpeg");
	...
	//---------------------------------second car button
		ImageIcon secondCarImage = new ImageIcon("../images/ladder.jpeg");
	...
	//---------------------------------------third car button
		ImageIcon thirdCarImage = new ImageIcon("../images/dewaltJackhammer.jpeg");
	...
	//------------------------------------------forth car button
		ImageIcon forthCarImage = new ImageIcon("../images/RigidJackhammer.jpeg");
	...
	private class firstCarButton implements ActionListener{ //when its clicked show up the car detail of Van
		...
		carDetailsTA.setText("");
		carDetailsTA.setText("Brand: Chainsaw \nPrice $1.99");
	...
	private class secondCarButton implements ActionListener{ //button to show pick-up details
		...
		carDetailsTA.setText("");
		carDetailsTA.setText("Brand: Ladder \nPrice $1.49");
	...
	private class thirdCarButton implements ActionListener{ //button to show Taxi details
		...
		carDetailsTA.setText("");
		carDetailsTA.setText("Brand: Dewalt \nJackhammer \nPrice $2.99");
	...
	private class forthCarButton implements ActionListener{ //button to show Bus details
		...
		carDetailsTA.setText("");
		carDetailsTA.setText("Brand: Ridgid \nJackhammer \nPrice $2.99");
	...
	private class finalStepButton implements ActionListener{
		public void actionPerformed(ActionEvent event) {
			...
			if(event.getActionCommand().equals("Car1")) { //passing the pick-up details to car details class and final transactions.
				...
				String carType = "Chainsaw", carModel = "Stihl";
				double carPrice = 1.99;
				...
				String carType = "Ladder", carModel = "Werner";
				double carPrice = 1.49;
				...
				String carType = "Jackhammer", carModel = "Dewalt";
				double carPrice = 2.49;
				...
				String carType = "Jackhammer", carModel = "Rigid";
				double carPrice = 2.49;
